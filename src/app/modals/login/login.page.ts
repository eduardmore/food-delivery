...
export class LoginPage implements OnInit {
  ...
  googleLogin() {
    ...
    var googleWebClientId = "719512729573-ap9oc0rttdse7ei2r5bq4pp2d3b5diqi.apps.googleusercontent.com"
  ...
  createAccount(info, type) {
    ...
    console.log('=== social login start here before call api === ')

...
export class EditAddressPage implements OnInit {
  ...
  constructor(
    ...
    if (this.type != 'add') {
      ...
      this.shippingData.entry_zone = this.data.state;
      ...
      this.shippingData.entry_country_name = 'Nigeria';      
      this.shippingData.entry_city = 'Kubuwa';
      this.shippingData.entry_postcode = '23401';
      this.shippingData.entry_country_id = '156';
      
      this.shared.tempdata.entry_country_id = '156';
      this.shared.tempdata.entry_country_name = 'Nigeria';
      this.shared.tempdata.entry_country_code = '156';
    }
  ...
  addShippingAddress = function (form) {
    ...
    dat.is_default = 0;
    console.log('add address data == ', dat);

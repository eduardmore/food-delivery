...
export class BillingAddressPage implements OnInit {
  ...
  setAddress(value) {
    if (value == true) {
      ...
      this.shared.orderDetails.billing_zone_id = this.shared.orderDetails.tax_zone_id;
    }
    else {
      ...
      this.shared.orderDetails.billing_zone_id = '';

      this.shared.orderDetails.billing_country = 'Nigeria';      
      this.shared.orderDetails.billing_country_id = '156';
      this.shared.orderDetails.billing_city = 'Kubuwa';
      this.shared.orderDetails.billing_postcode = '23401';
    }
  }
  submit() {
    this.shared.orderDetails.billing_state = this.shared.orderDetails.billing_zone;

...
export class MyAccountPage implements OnInit {
  ...
  updateInfo() {
    ...
    if (this.myAccountData.currentPassword != "" && this.myAccountData.password == "") {
      this.shared.toast("Please Confirm Your New Password!");
      return;
    } else if (this.myAccountData.currentPassword != "" && this.myAccountData.currentPassword != this.myAccountData.password) {
      this.shared.toast("New Password not matched!");
      return;
    ...
    this.config.postHttp('updatepassword', dat).then((data: any) => {

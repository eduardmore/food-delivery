...
if (localStorage.langId == undefined) {
  ...
  localStorage.currencyCode = "NGN";  //default currency code
...
export class ConfigService {
  ...
  estateSones = [
    {zone_name: 'Brickcity phase 1', zone_id: '9010101'},
    {zone_name: 'Brickcity phase 2', zone_id: '9010102'},
    {zone_name: 'Brickcity phase 3 (Spring)', zone_id: '9010103'},
    {zone_name: 'Brickcity phase 3c (View)', zone_id: '9010104'},
    {zone_name: 'Brickcity phase 3b (Valley)', zone_id: '9010105'},
    {zone_name: 'Lennar Hillside estate', zone_id: '9010106'},
    {zone_name: 'APDC Capital estate', zone_id: '9010107'},
    {zone_name: 'Blocks of flat estate by brickcity', zone_id: '9010108'},
    {zone_name: 'Others', zone_id: 'others'}
  ]

  public yourSiteUrl: string = 'https://srv.brickcityeshop.com/public';
  public consumerKey: string = "04bc8bb71597579679e522a9c8";
  public consumerSecret: string = "598d899e159757967980e38294";
  ...
  defaultSettings() {
    ...
    console.log('nofi type == ', this.notificationType)
